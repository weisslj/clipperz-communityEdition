...
//deferredResult.addBoth(function(res) {MochiKit.Logging.logDebug("User.deleteRecords parameters: " + MochiKit.Base.serializeJSON(res)); return res;});
...
//MochiKit.Logging.logDebug("### LoginInfo: " + MochiKit.Base.serializeJSON(aValue));
	},
