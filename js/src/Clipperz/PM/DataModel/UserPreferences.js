...
//MochiKit.Logging.logDebug(">>> Clipperz.PM.DataModel.UserPreferences.updateWithData: " + MochiKit.Base.serializeJSON(someValues));
...
//MochiKit.Logging.logDebug(">>> UserPreferences.configValue - config: " + MochiKit.Base.serializeJSON(this.config()));
