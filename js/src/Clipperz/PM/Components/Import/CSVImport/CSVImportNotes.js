...
YAHOO.extendX(Clipperz.PM.Components.Import.CSVImport.CSVImportNotes, Clipperz.PM.Components.BaseComponent, {
	...
	'render': function() {
		...
		this.domHelper().append(this.element(), {tag:'div', children:[
			{tag:'div', cls:'importStepDescription', html:Clipperz.PM.Strings['CSV_ImportWizard_Notes']},
			{tag:'div', id:this.getId('dataDiv'), children:[
				{tag:'div', cls:'importStepParameters', children:[
					...
					{tag:'span', id:this.getId('doNotSetNotes_span'), cls:'clickableSpan', html:Clipperz.PM.Strings['CSV_ImportWizard_Notes_Settings_noSelectionLabel']}
				]},
...
//		}
		...
		MochiKit.Base.map(function(aRowConfig) {YAHOO.ext.DomHelper.append(anElement, aRowConfig);}, config);
