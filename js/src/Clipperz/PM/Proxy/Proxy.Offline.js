...
//MochiKit.Logging.logDebug("--- Proxy_Offline.handshake - someParameters: " + Clipperz.Base.serializeJSON(someParameters));
...
//MochiKit.Logging.logDebug("<<< Proxy_Offline.handshake: " + Clipperz.Base.serializeJSON(result));
...
//MochiKit.Logging.logDebug(">>> Proxy_Offline.message: " + Clipperz.Base.serializeJSON(someParameters));
...
//MochiKit.Logging.logDebug("#### record: " + Clipperz.Base.serializeJSON(recordData));
...
//MochiKit.Logging.logDebug("### currentVersionData: " + Clipperz.Base.serializeJSON(currentVersionData));
...
//MochiKit.Logging.logDebug("<<< Proxy_Offline.message: " + Clipperz.Base.serializeJSON(result));
		return MochiKit.Async.succeed(result);
	},
